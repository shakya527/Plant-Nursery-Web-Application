...
// FILE      : customer/view_invoice.php
...
// Fetch order header (Ensures order belongs to this customer)
$order = db_query_one("SELECT * FROM orders WHERE order_id = ? AND customer_id = ?", "ii", [$order_id, $customer_id]);

if (!$order) {
    die("<div style='padding:40px;text-align:center;color:red;font-family:Arial;'>Order not found or unauthorized access.</div>");
}
...
<div class="container fade-in" style="padding-top: var(--space-xl);">
    <?php if (isset($_GET['success'])): ?>
        <div class="alert alert-success no-print">🎉 Order placed successfully! Thank you for shopping with GreenThumb.</div>
    <?php endif; ?>
    ...
    <div class="card" style="background: white; color: #333; padding: 40px; border-radius: 8px;">
        ...
        <div class="flex justify-between items-center" style="border-bottom: 2px solid #eee; padding-bottom: 20px; margin-bottom: 30px;">
            <div>
                ...
                <p style="color:#666;font-size:0.9rem;">Jalan Hijau, 50000 Kuala Lumpur</p>
            </div>
        ...
        <div class="grid-2" style="margin-bottom: 40px;">
            ...
            <div style="text-align:right;">
                 <!-- Placeholder for QR code or payment terms -->
            </div>
        </div>
        ...
        <div style="margin-top:50px;text-align:center;color:#888;font-size:0.85rem;border-top:1px solid #eee;padding-top:20px;">
            Thank you for your business! For any enquiries regarding this invoice, please contact info@greenthumb.com.
        </div>
    </div>
</div>
